...
print()
print("the value of a is {0}, the value of b is {1}, the value of c is {2}, and the value of f is {3}".format(a, b, c, f))
print(f"the value of a is {a}, the value of b is {b}, the value of c is {c}, and the value of f is {f}")
